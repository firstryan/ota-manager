...
Operational Commands:
  ...
  rollback <v> [ch] : Rollback / Downgrade ke versi lama (e.g., rollback 0.2.0.11 training).
    ...
    try {
        switch (command) {
            ...
            case 'set-version':
                ...
                if (await confirm(`ARE YOU SURE you want to rollback ${rbChannel.toUpperCase()} to version v${subArg}?`)) {
